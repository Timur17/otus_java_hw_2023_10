...
import ru.otus.threads.ThreadRunner;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        executor.submit(new ThreadRunner(threadService, timeoutForLoop, "FIRST", firstCounter, secondCounter));
        executor.submit(new ThreadRunner(threadService, timeoutForLoop, "SECOND", secondCounter, firstCounter));
